...
class OrderingTableViewController: UIViewController {
    ...
    @IBAction func finishOrder(_ sender: UIButton) {
        if nameTextField.text == "" {
            ...
            SendMailManager.shared.sendMailWithData(userEmail: email, text: CartManager.shared.formText(phoneNumber: telephoneTestField.text!, email: email, name: nameTextField.text!)) { success in
                if success {
